  ...
  const [datas , setdatas] = useState(
    ...
    <div className='main-das'> 
       ...
       <div className='second-das'>
        <div className='box-1'>
        <CalendarFill style={{color:"lightgray",marginLeft :"11rem",marginTop:"0.5rem",fontSize:"2rem"}}/>
        ...
        <span style={{color:"rgb(181, 181, 181)",fontSize :"1.4rem"}}>$40,000</span>
          ...
          <div className='box-2'>
          <CurrencyDollar style={{color:"lightgray",marginLeft :"11rem",marginTop:"0.5rem",fontSize:"2.2rem"}}/>
          ...
          <span style={{color:"rgb(181, 181, 181)",fontSize :"1.4rem"}}>$215,000</span>
            ...
            <div className='box-3'>
            <Clipboard2DataFill style={{color:"lightgray",marginLeft :"11rem",marginTop:"0.5rem",fontSize:"2rem"}}/>
             ...
             <div className='box-4'>
             <ChatDotsFill style={{color:"lightgray",marginLeft :"11rem",marginTop:"0.5rem",fontSize:"2rem"}}/>
