    ...
    <div className='contanier'>
     ...
     <div className='thir_container'>
        ...
        <p>We get it, stuff happens.
         ...
         <br/>
         <button className='reset-btn' ><Link to='/login' style={{textDecoration:"none",fontSize:"0.8rem"}}>Reset Password</Link></button> <br/>
        <br/> <hr/> <br/>
         <Link to='/create'><span className='acc_link_2'>Create an Account!</span></Link> <br/>
         <Link to='/login'><span className='acc_link_2'>Already have an account? Login!</span></Link>
     </div>
    </div>
  )
}
